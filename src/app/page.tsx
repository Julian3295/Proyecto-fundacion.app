            ...
            {pokemon.map((p) => (
              <div key={p.id} className="p-3 bg-black/50 rounded-xl border border-gray-800 flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="uppercase text-xs font-bold text-white">{p.name}</p>
                  <div className="mt-1">
                    ...
                    <div className="w-full bg-gray-800 h-1 rounded-full">
                      <div className="bg-green-500 h-full rounded-full" style={{width: `${p.stats[5].base_stat}%`}}></div>
                    </div>
                  </div>
                  <div className="mt-1">
                    <p className="text-[10px] text-gray-400 flex justify-between">
                    ...
                    <div className="w-full bg-gray-800 h-1 rounded-full">
                      <div className="bg-blue-500 h-full rounded-full" style={{width: `${p.stats[1].base_stat}%`}}></div>
                    </div>
                  </div>
                </div>
              </div>
