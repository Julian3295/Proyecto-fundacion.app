...
export default function Home() {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      ...
      // Llamada a la API de juegos (Asegúrate de crear app/api/games/route.ts)
      fetch('/api/games')
        .then(res => res.json())
  ...
  if (!isAuthenticated) return <AuthModal onLogin={() => window.location.reload()} />;
    ...
    <main ref={containerRef} className="min-h-screen bg-[#030712] text-white relative">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-32 pb-20 space-y-20">
        ...
        <header className="text-center mb-10">
          {/* LOGO ACTUALIZADO PARA CORREGIR LCP Y ASPECT RATIO */}
          <Image 
                  ...
                  <div className="aspect-video relative overflow-hidden">
                    <div className="absolute inset-0 bg-linear-to-t from-[#030712] to-transparent z-10" />
                      <Image 
                        ...
                        unoptimized // <--- PRUEBA ESTO: Si esto las arregla, es un tema de configuración de Next.js
                        />
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="w-full text-left space-y-2">
                ...
                <div className="h-2 w-full bg-white/5 rounded-full p-0.5">
                  <div className="h-full bg-emerald-500 rounded-full" style={{ width: stats.poder }}></div>
                </div>
              </div>
